...
export function FluxoBot() {
  ...
  const [useAIConfig, setUseAiConfig] = useState<useAIConfigType | undefined>(
    undefined
  );
      ...
      if (nodeId) {
        const newProps = {
          ...
          markerEnd: {
            ...
            height: 30,
            color: "#FF9000",
          }, // Nova configuração para markerEnd
        };
  ...
  const saveConfig = async (published: boolean = false) => {
    try {
      ...
      await AuthService.updateFileConfig(token, {
        data: data,
      });
    ...
    if (fileEdition && Object.keys(fileEdition).length > 0) {
      if (fileEdition && fileEdition && fileEdition.variables) {
        const variaveis = Object.fromEntries(
          Object.entries(fileEdition.variables)
        );
      ...
      {carregando ? (
        ...
        <Content>
          <MenuFluxoLateral>
            <ul>
              {useAI && (
                <li onClick={() => setVisualizando("useAi")}>
                  <IconEdit />
                </li>
              )}
              {!useAI && (
              ...
              <li onClick={() => setVisualizando("configuracoes")}>
                <IconEdit />
              </li>
              <li onClick={() => setVisualizando("variaveis")}>
                <IconEdit />
              </li>
              <li onClick={() => publicFile()}>
                <IconEdit />
              </li>
            </ul>
          </MenuFluxoLateral>
            ...
            >
              ...
              {idselected != "" ? (
                <MenuFLuxoConfig
                  ...
                  setFileEdition={setFileEdition}
                  nodeReact={nodeReact}
                  setNodeReact={setNodeReact}
                  edges={edges}
                  setEdges={setEdges}
                >
                  Teste
            ...
            <ContentUseAI>
              <ContainerCard>
                <div className="box1">
                  ...
                  <Subtitle>
                    Atualmente temos duas Opções para voce poder utilizar.
                    OpenAi e Gemini. Ambas IA funcionam da mesma maneira.
                  </Subtitle>
                </div>
                <div className="box2">
                  <select
                    onChange={(e) =>
                      handlePromptIA(e.target.value, "ai_selected")
                    }
                    value={useAIConfig?.ai_selected}
                  >
                    <option value={"-"}>-</option>
              ...
              <ContainerCard>
                ...
                <div className="box2">
                  <input
                    type="text"
                    value={useAIConfig && useAIConfig.key}
                    onChange={(e) => handlePromptIA(e.target.value, "key")}
                  />
                </div>
              </ContainerCard>
              <ContainerCard>
                ...
                <div className="box3">
                  <textarea
                    rows={20}
                    onChange={(e) => handlePromptIA(e.target.value, "prompt")}
                    value={useAIConfig && useAIConfig.prompt}
                  >
                    ...
                    <tr key={chave}>
                      <td>
                        <input
                          ...
                          value={chave}
                          onChange={(e) =>
                            handleChangeVariables(chave, e.target.value, valor)
                          }
                        />
                      </td>
                      <td>
                        <input
                          ...
                          value={valor}
                          onChange={(e) =>
                            handleChangeVariables(chave, chave, e.target.value)
                          }
                        />
                      </td>
                    </tr>
            ...
            <ContentConfiguracoes>
              <ContainerCard>
                <div className="box1">
                  ...
                  <Subtitle>
                    Tempo maximo que o bot mantem a sessao aberta em segundos.
                  </Subtitle>
                </div>
                <div className="box2">
                  <input
                    ...
                    value={
                      useAIConfig &&
                      fileEdition.configurations.endTimeSessionRedis
                    }
                    onChange={(e) =>
              ...
              <ContainerCard>
                <div className="box1">
                  ...
                  <Subtitle>
                    Tempo de espera para o bot enviar mensagens em segundos.
                  </Subtitle>
                </div>
                <div className="box2">
                  <input
                    ...
                    value={
                      useAIConfig &&
                      fileEdition.configurations.timeAwaitSendMessage
                    }
                    onChange={(e) =>
                      handleConfigurations(
                        e.target.value,
                        "timeAwaitSendMessage"
                      )
                    }
                  />
                </div>
              ...
              <ContainerCard>
                <div className="box1">
                  ...
                  <Subtitle>
                    <p>
                      Usar inteligencia Artifical e criar um atendimento
                      personalizado
                    </p>
                    <p>Plataformas suportadas até o momento: GEMINI & OPENAI</p>
                    <p>
                      Ativando esta Opção, o fluxo desenhado anteriormente não
                      terá valor, e apenas o prompt aqui configurado terá
                      influencia.
                    </p>
                  </Subtitle>
                </div>
